                ...
                <div className="grid grid-rows-[1fr_auto] gap-10">
                    <div className="grid grid-rows-[auto_1fr] gap-5">
                        <p className="h-max w-full text-pretty leading-7 text-mistGray-300">
                            ...
                            <em title="Business Administration" className="not-italic text-mistGray-50">
                            ...
                            and{" "}
                            <em title="Full-stack Development" className="not-italic text-mistGray-50">
                            ...
                            {highEducationCourses.map((course) => (
                                ...
                                >
                                    ...
                                    <p className="flex items-center justify-between text-mistGray-300">
                                        UNESA{" "}
                                        <span className="text-xs leading-none text-mistGray-800">{course.year}</span>
                                    </p>
                                </div>
                            ))}
                        </div>
                    ...
                    <div className="mx-auto w-max sm:mx-0">
                        ...
                        <ul className="flex flex-col gap-4">
                            {[...intensiveCourses].reverse().map((item, index) => (
                                <li className="font-medium tracking-wide text-mistGray-50" key={item.id + "-" + index}>
                                    {item.course}{" "}
