...
function SheetOverlay({ className, ...props }: Readonly<React.ComponentProps<typeof SheetPrimitive.Overlay>>) {
    return (
...
function SheetDescription({ className, ...props }: Readonly<React.ComponentProps<typeof SheetPrimitive.Description>>) {
    return (
